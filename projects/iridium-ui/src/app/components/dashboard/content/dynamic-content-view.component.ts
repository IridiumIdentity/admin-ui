...
export class DynamicContentViewComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(DynamicContentViewDirective, { static: true })
  dynamicContentViewHost!: DynamicContentViewDirective;
  ...
  loadSingleComponent() {
    ...
    const componentRef =
      viewContainerRef.createComponent<DynamicContentViewItem>(
        this.view.component
      );
